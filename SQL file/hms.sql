...
INSERT INTO tblpage (ID, PageType, PageTitle, PageDescription, Email, MobileNumber, UpdationDate, OpenningTime) 
VALUES 
(1, 'aboutus', 'About Us', 
'<ul style="padding: 0px; margin-right: 0px; margin-bottom: 1.313em; margin-left: 1.655em; font-family: Times New Roman; font-size: 14px; text-align: center; background-color: rgb(255, 246, 246);">
    <li style="text-align: left;">
        <font color="#000000">
            The Bai Ratanabai Gharda Hospital (HMS) is designed for any hospital to replace their existing manual, paper-based system. 
    ...
    <li style="text-align: left;">
        <font color="#000000">
            ...
            This information typically involves: patient personal information and medical history, staff information, room and ward scheduling, staff scheduling, operating theater scheduling, and various facilities waiting lists. 
            All of this information must be managed in an efficient and cost-wise fashion so that an institution\'s resources may be effectively utilized. 
...
(2, 'contactus', 'Contact Details', 'Lavel, Khed, Maharashtra, India', 'info@gmail.com', 1122334455, '2020-05-20 07:24:07', '9 am To 8 Pm');
